...
import { useParams } from 'next/navigation'; // ✅ Correct import for `useParams` in app router
...
export default function EditUserPage() {
  ...
  const id = params?.id; // ✅ safe access (important for hydration)
  ...
  if (isLoading) {
    return (
      <div className="flex min-h-screen bg-white">
        ...
        <div className={`flex-1 flex items-center justify-center transition-all duration-300 ${isSidebarOpen ? 'lg:ml-64' : 'lg:ml-0'}`}>
