...
const Page = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(
        `Error: ${error.response?.data?.message || "Failed to save appliance"}`
      );
    }
  };
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-5xl space-y-8">
          ...
          <div className={sectionWrapperStyle}>
            <h2 className={sectionTitleStyle}>Appliance Detail</h2>
            <p className={sectionDescriptionStyle}>
              Add your appliance's relevant detail
            </p>
          ...
          <div className={sectionWrapperStyle}>
            ...
            <p className={sectionDescriptionStyle}>
              Add your appliances relevant detail
            </p>
          ...
          <div className={sectionWrapperStyle}>
            ...
            <p className={sectionDescriptionStyle}>
              Add more detail about appliance
            </p>
            <div>
              <textarea
                id="additionalNotes"
          ...
          <div className="flex justify-end space-x-4 pt-4">
            <Link href="/Dashboard/applianceManagement">
              <button
                type="button"
