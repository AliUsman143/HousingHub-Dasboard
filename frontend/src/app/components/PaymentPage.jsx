...
const PaymentPage = () => {
  ...
  const sectionWrapperStyle = "bg-white p-3 sm:p-5 rounded-lg shadow-sm border border-gray-200";
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center py-2 px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex items-center justify-center mb-5 w-full max-w-md">
        ...
        <div className="flex flex-col items-center">
          ...
          <span className="text-sm text-blue-800 mt-2 font-medium">Payment</span>
        </div>
        <div className="flex-1 h-0.5 bg-gray-300 mx-2 sm:mx-4"></div>
        <div className="flex flex-col items-center">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <div className="absolute right-3 top-1/2 -translate-y-1/2 flex space-x-1">
                  ...
                  <img src="https://placehold.co/30x20/ffffff/000000?text=VISA" alt="Visa" className="h-5 rounded" />
                  <img src="https://placehold.co/30x20/ffffff/000000?text=MC" alt="Mastercard" className="h-5 rounded" />
                  <img src="https://placehold.co/30x20/ffffff/000000?text=DISC" alt="Discover" className="h-5 rounded" />
                </div>
              </div>
            </div>
